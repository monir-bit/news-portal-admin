...
{{--        <img src="https://breakingnews.com.bd/img/logo2.png" alt="AdminLTE Logo" class="main-image__image">--}}
        <h2 style="font-size: 28px">আগামীর সময়</h2>
    </a>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @if (in_array(auth()->user()->role, ['admin', 'publisher', 'editor', 'desk_reporter', 'representative']))
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ Url('/admin/news/breaking/index') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Add New Breaking</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ Url('/admin/news/breaking/list') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>View All Breaking</p>
                                </a>
                            </li>
                        </ul>
                    </li>
