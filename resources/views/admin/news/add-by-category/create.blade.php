                            ...
                            <div class="row">
                                ...
                                <div class="col-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="details" class="" name="details">Place <em>some</em> <u>text</u> <strong>here</strong></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="sort_description">Sort Description</label>
                                        <textarea id="sort_description" class="" name="sort_description">Place <em>sort</em> <u>description</u> <strong>here</strong></textarea>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                ...
                                <input type="text"  name="caption" class="form-control"  placeholder="Enter caption">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="reporter-id" name="reporter_id"
                                            style="width: 100%;">
                                    ...
                                    <div class="form-group">
                                        <label for="hash_id">Hash ID (Unique Alphanumeric String)</label>
                                        <input type="text" name="hash_id" class="form-control" id="hash_id" readonly
                                               placeholder="Auto-generated 10-character alphanumeric string" style="background-color: #e9ecef;">
                                        <small class="form-text text-muted">This is an immutable unique identifier (NanoID style). It will be auto-generated when you save the news.</small>
                                    </div>
                                    <div class="form-group">
...
@section('scripts')
    ...
    <script>
$(document).ready(function() { $('.textarea').richText(); $('.textarea2').richText(); }); 
</script>
@endsection