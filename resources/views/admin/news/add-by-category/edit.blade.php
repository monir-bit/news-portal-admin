                            ...
                            <div class="row">
                                <div class="col-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="details" class="" name="details">{!! $news->details->details !!}</textarea>
                                    </div>
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="hash_id" class="form-control" id="hash_id" 
                                               value="{{ $news->slug ?? '' }}" readonly
                                               placeholder="Auto-generated 10-character alphanumeric string" style="background-color: #e9ecef;">
                                        <small class="form-text text-muted">This is an immutable unique identifier (NanoID style). It cannot be changed after creation.</small>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span><img src="{{$news->image}}" height="100"></span>
                                    </div>
                                     <div class="form-group">
                                <label for="order">Caption</label>
                                <input type="text"  name="caption" value="{{ $news->caption }}" class="form-control"  placeholder="Enter caption">
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="reporter-id" name="reporter_id"
                                            ...
                                            @foreach ($weare as $we)
                                                <option value="{{ $we->id }}" <?php if ($we->id == $news->reporter_id) {
                                                echo 'selected';
                                            } ?>>
                                                    {{ $we->name }}</option>
                                            @endforeach
