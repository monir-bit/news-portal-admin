                            ...
                            <tbody>
                                @foreach ($news as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->title }}</td>
                                        <td>{{ $item->details->representative ?? '' }} {{$item?->reporter?->name}} </td>
                                        ...
                                        <td>
                                           ...
                                           {{-- @if (in_array(auth()->user()->role, ['admin', 'publisher', 'editor', 'desk_reporter']) &&
                                                ...
                                                @if($item->published == 0)
                                                <a class="btn btn-success mt-3"
                                                    href="{{ Url('/admin/news/publishadd', $item->id).'/pub' }}"><i
                                                        class="fas fa-eye"></i> Publish</a></a>
                                                @else
                                                <a class="btn btn-danger mt-3"
                                                    href="{{ Url('/admin/news/publishadd', $item->id).'/unpub' }}"><i
                                                        class="fas fa-eye"></i> Unpublish</a></a>
                                                @endif
                                         {{--   @endif--}}
                                            @if (in_array(auth()->user()->role, ['admin', 'publisher', 'editor', 'desk_reporter']) &&
                                                $item->published == 0 &&
