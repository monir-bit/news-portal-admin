            ...
            <form id="quickForm" method="POST" action="{{Url('/admin/news/category/update')}}">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="slug" class="form-control" id="slug" value="<?= $category->slug ?? ''; ?>" placeholder="Auto-generated from name, or enter manually">
                        <small class="form-text text-muted">Leave empty to auto-generate from category name. You can manually edit this slug.</small>
                    </div>
                </div>
                <!-- /.card-body -->
