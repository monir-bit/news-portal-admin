            ...
            <form id="quickForm" method="POST" action="{{Url('/admin/news/subcategory/update')}}">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="slug" class="form-control" id="slug" value="<?= $subcategory->slug ?? ''; ?>" placeholder="Auto-generated from name, or enter manually">
                        <small class="form-text text-muted">Leave empty to auto-generate from subcategory name. You can manually edit this slug.</small>
                    </div>
                </div>
                <!-- /.card-body -->
